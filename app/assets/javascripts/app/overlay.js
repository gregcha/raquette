$(document).ready(function(){
  ...
  $('.open-toggler').click(function(){
    $('#overlay-libelleReservation').html($(this).next('.is-hidden').children('form').children('#libelleReservation').val());
